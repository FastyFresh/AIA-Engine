"""Test background reference feature"""
import asyncio
import sys
sys.path.insert(0, '.')
...
async def test_background():
    ...
    # Use the teal bikini pose with luxury hotel suite background
    result = await service.transform_with_pose_source(
        ...
        filename_prefix="bgref_hotel_test"
    )
...
print("Testing background reference with luxury hotel suite...")
