"""Transform V7 Batch - All 3 test images"""
import asyncio
import sys
import os
import shutil
...
PHOTOGRAPHY STYLE:
- Photorealistic, natural skin texture, real photograph
- Professional photography with natural lighting
- NOT illustration, NOT cartoon, NOT stylized, NOT digital art, NOT CGI
...
- Body: Healthy slim petite figure with natural proportions as shown in body reference. NOT underweight, NOT skeletal.
...
This must look like a real photograph of a real person."""
...
async def transform_image(source_path: str, output_path: str, background_desc: str, fal_key: str) -> dict:
    ...
    negative_prompt = "cartoon, illustration, anime, stylized, digital art, 3d render, cgi, painting, drawing, light hair, blonde, honey hair, reddish hair, auburn, ginger, skeletal, underweight, anorexic, emaciated, multiple people, blended face, morphed features"
...
async def main():
    ...
    for src_path in test_images:
        ...
        print(f"  Preset: {analysis.get('matched_preset')}")
